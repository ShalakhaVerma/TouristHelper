package customviews.circleindicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultPageColor = res.getColor(R.color.desc_color);
        ...
        // }
        int backgroundResId = a.getResourceId(R.styleable.CirclePageIndicator_backgroundd, 0);
